...
if (output) then
        if(ioparg == 0 .and. iopang == 1) write(30, 1440) arg(jarg), s1c(jarg), is1e(jarg), naccs(jarg)
        if(ioparg == 0 .and. iopang == 2) write(30, 1450) arg(jarg), s1c(jarg), is1e(jarg), s1dc(jarg), &
...
1450      format(1x, f19.14, 2x, f17.14, 2x, i5, 2x, f17.14, 2x, i5, 2x, i2,', ',i2)
        if(ioparg == 1 .and. iopang == 1) write(30, 1460) barg(jarg), s1c(jarg), is1e(jarg), naccs(jarg)
        if(ioparg == 1 .and. iopang == 2) write(30, 1470) barg(jarg), s1c(jarg), is1e(jarg), s1dc(jarg), &
                                is1de(jarg), naccs(jarg), naccds(jarg)
